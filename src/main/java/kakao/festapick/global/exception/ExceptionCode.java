...
public enum ExceptionCode {
    ...
    FM_PERMISSION_DUPLICATE("이미 FESTIVAL_MANAGER 승급 신청을 했습니다."),
    FESTIVAL_PERMISSION_DUPLICATE("이미 축제 관리 신청을 했습니다."),
    ...
    FESTIVAL_PERMISSION_BAD_REQUEST("이미 관리자가 존재하는 축제입니다."),
    PERMISSION_ACCEPTED_BAD_REQUEST("이미 승인이 완료된 요청입니다."),
